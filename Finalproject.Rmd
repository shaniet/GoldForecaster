...
for (i in 1:length(folds)){ 
  ...
  pcr.mdl.r <- pcr(PercChangeForc ~., data = gold.r.train, scale = TRUE, 
                   validation = "CV")
  validationplot(pcr.mdl.r, val.type = "MSEP")
} 
...
### Some preliminary boundry visuals
```{r}
library(ggplot2)
...
plot(gold.c$PercChangeLag1, gold.c$FedFundsRate, col = as.factor(gold.c$Binary.PercChange), 
     xlab = "PercChangeLag1", ylab = "FedFundsRate")

# Add a legend
legend("topright", legend = c("Class 0", "Class 1"), col = c("blue", "red"), pch = 1)

# Add a title
title("Scatter Plot of PercChangeLag1 vs. FedFundsRate")
